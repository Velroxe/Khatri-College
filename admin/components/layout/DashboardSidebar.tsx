...
import { Home, Users, Settings, X, LogOut, BookOpen, UserLock, GraduationCap, UserStar } from "lucide-react";
...
const navLinks = [
  ...
  { name: "Admins", href: "/admins", icon: UserLock },
  { name: "Courses", href: "/courses", icon: BookOpen },
  { name: "Students", href: "/students", icon: Users },
  { name: "Scholars", href: "/scholars", icon: GraduationCap },
  { name: "Faculties", href: "/faculties", icon: UserStar },
